...
<body>
  ...
  <div class="container sm-container-fluid form-design">
    <h1 class="text-right">ShortcutKey<span id="name"></span></h1>
    <form class="form-inline" id="frm">
      ...
      <div class="mb-3 col-md-6 col-sm-12">
        <label for="exampleInputText1" class="form-label">Perfection(10)</label>
      ...
      <div class="mb-3 col-md-6 col-sm-12">
        <label for="exampleInputText1" class="form-label">Completion(10)</label>
