...
<body>
  ...
  <div class="container sm-container-fluid form-design">
    <h1 class="text-right">Technical Dubmash<span id="name"></span></h1>
    <form class="form-inline" id="frm">
      ...
      <div class="mb-3 col-md-6 col-sm-12">
        <label for="exampleInputText1" class="form-label">Voice Synchronisation Marks(10)</label>
        <input type="number" class="form-control" id="m1" name="m1" placeholder="0" required autocomplete="off" aria-describedby="textHelp">
        <div id="error" class="form-m1"></div>
      </div>
      <div class="mb-3 col-md-6 col-sm-12">
        <label for="exampleInputText1" class="form-label">Presentation Marks(10)</label>
        <input type="number" class="form-control" id="m2" name="m2" placeholder="0" autocomplete="off" aria-describedby="textHelp">
        <div id="error" class="form-m2"></div>
      </div>
      <div class="mb-3 col-md-6 col-sm-12">
        <label for="exampleInputText1" class="form-label">Concept Used Marks(10)</label>
        <input type="number" class="form-control" id="m3" name="m3" placeholder="0" autocomplete="off" aria-describedby="textHelp">
