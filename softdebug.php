...
<body>
  ...
  <div class="container sm-container-fluid form-design">
    <h1 class="text-right">Software Debugging<span id="name"></span></h1>
    <form class="form-inline" id="frm">
      ...
      <div class="mb-3 col-md-6 col-sm-12">
        <label for="exampleInputText1" class="form-label">Bugs Remained Marks(25)</label>
      ...
      <div class="mb-3 col-md-6 col-sm-12">
        <label for="exampleInputText1" class="form-label">Completed Marks(25)</label>
        <input type="number" class="form-control" id="m2" name="m2" placeholder="0" required autocomplete="off" aria-describedby="textHelp">
